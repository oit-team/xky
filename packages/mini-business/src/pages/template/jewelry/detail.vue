  ...
  <container classes="flex flex-col bg-gray-100">
    ...
    <div class="flex flex-col gap-3 p-3">
      ...
      <van-cell-group>
        ...
        <van-cell :title="getLabel('productSource')">
          <template>
            <rich-text :nodes="getValue('productSource')" />
          </template>
        </van-cell>
        <van-cell :title="getLabel('productPrecautions')">
          <template>
            <rich-text :nodes="getValue('productPrecautions')" />
          </template>
        </van-cell>
      </van-cell-group>
